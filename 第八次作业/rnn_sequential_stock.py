...
sgd = tf.keras.optimizers.SGD(lr=0.000001, decay=1e-10, momentum=0.9, nesterov=True)
...
history = model.fit(x_train, y_train, epochs=100, batch_size=1, validation_data=(x_test, y_test), validation_freq=1,
