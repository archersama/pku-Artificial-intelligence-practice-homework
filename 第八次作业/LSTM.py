...
model = tf.keras.Sequential([
    ...
    # Dropout(0.2),
    LSTM(128,activation='relu',return_sequences=False,unroll=True),
    Dropout(0.2),
    Dense(1)
])
...
history = model.fit(x_train, y_train, epochs=50, batch_size=16, validation_data=(x_test, y_test), validation_freq=1,
